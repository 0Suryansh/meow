...
export default ({
  ...
  subheading = "",
  description = "Software-as-a-service solution to manage carbon emissions, allowing its customers to analyze and evaluate their emissions data."
}) => {
  ...
  const defaultCards = [
    ...
    { imageSrc: SupportIconImage, title: "Reduce " },
